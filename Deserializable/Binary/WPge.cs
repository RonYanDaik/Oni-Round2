...
{
  internal class WPge: Round2.BinaryInitializable
  {
      /// <summary>
      ///File id
      /// </summary>
      ...
      /// <summary>
      ///Link to the Oni Weapon Class
      /// </summary>
      public System.Int32 m_ONWC_link_8;
      /// <summary>
      ...
      public void Convert(byte[] data)
      {
         ...
         this.m_ONWC_link_8 = (System.Int32)BinaryDatReader.l_int32(l_bytes, 4);
         for(int i=0; i<4; i++)
         {
             l_bytes[i] = data[i + 12];
         }
