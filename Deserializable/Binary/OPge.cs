...
{
  internal partial class OPge: Round2.BinaryInitializable
  {
      /// <summary>
      ///File id
      /// </summary>
      ...
      public void Convert(byte[] data)
      {
         ...
         this.m_Level_A = (System.Int16)BinaryDatReader.l_int16(l_bytes, 2);
         for(int i=0; i<4; i++)
         {
             l_bytes[i] = data[i + 12];
         }
         this.m_IGPA_link_C = (System.Int32)BinaryDatReader.l_int32(l_bytes, 4);
         for(int i=0; i<4; i++)
         {
             l_bytes[i] = data[i + 16];
         }
